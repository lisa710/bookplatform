...
<!--            </li>-->
    ...
    <div class="centercontent">
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="stdtable"  style="background:#fff">
        <thead>
        <tr>
            <th colspan="4" scope="col">EFUCMS正版:2020年04月14日，服务器当前日期【<?php echo date('Y-m-d'); ?>】
        ...
        <tr>
            <td colspan="4">当前版本：<span class="layui-badge">E10.0高级版    </span> 授权类型：<span class="layui-badge">商业授权版</span></td>
        </tr>
        </tbody>
    </table>
    </div>
